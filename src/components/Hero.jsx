...
import Main1 from "../img/header/pexels_home.jpg";
// import Main2 from "../img/header/home-img-2.jpg";
import Main2 from "../img/header/pexels_skincare.jpg";
// import Main3 from "../img/header/home-img-3.jpg";
import Main3 from "../img/header/pexels_kichen.jpg";
// import Main4 from "../img/header/home-img-4.jpg";
import Main4 from "../img/header/pexels_electronics.jpg";
          ...
          <div className="grid-container">
            <div className="featured grid-one">
              <Link to="categories/furnitures">
                ...
                <p className="main-description">Home Interior</p>
              </Link>
            </div>
